const {
  ...
  showSingleCategoryService,
  deletingCategoryService,
  createSubCategoryService,
  showSingleSubCategoryService,
  showAllSubCategoryService,
  deletingSubCategoryService,
} = require("../../core/services/categoryServices/categoryServices");
...
module.exports = {
  async createCategoryController(req, res) {
    try {
      let response = await createCategoryService(req.body);
      return res.status(response.status).send(response);
    } catch (error) {
      console.error(error);
      const newError = createErrorMessage();
      newError.data = error;
      newError.message = "Create Category Controller Internal Server Error";
  ...
  async createSubCategoryController(req, res) {
    try {
      ...
      const newError = createErrorMessage();
      newError.data = error;
      newError.message = "Create Sub Category Controller Internal Server Error";
      newError.status = statusCode.internalServerError;
      newError.error = true;
      return res.status(newError.status).json(newError);
    }
  ...
  async showAllCategoryController(req, res) {
    try {
      let response = await showAllCategoryService();
      return res.status(response.status).send(response);
    } catch (error) {
      console.error(error);
      const newError = createErrorMessage();
      newError.data = error;
      newError.message = "Show All Category Controller Internal Server Error";
      newError.status = statusCode.internalServerError;
      newError.error = true;
      return res.status(newError.status).json(newError);
    }
  ...
  async showAllSubCategoryController(req, res) {
    try {
      let response = await showAllSubCategoryService();
      return res.status(response.status).send(response);
    } catch (error) {
      console.error(error);
      const newError = createErrorMessage();
  ...
  async showSingleCategoryController(req, res) {
    try {
      let response = await showSingleCategoryService(req.params);
      return res.status(response.status).send(response);
    } catch (error) {
      console.error(error);
      const newError = createErrorMessage();
  ...
  async deleteSubCategoryController(req, res) {
    try {
      ...
      const newError = createErrorMessage();
      newError.data = error;
      newError.message = "Delete Sub-Category Controller Internal Server Error";
      newError.status = statusCode.internalServerError;
      newError.error = true;
      return res.status(newError.status).json(newError);
    }
